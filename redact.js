...
$(document).ready(function () {
    ...
    // This give arrays "pushUnique" function // If the item you wish to push exists in the array, then you get back its
    ...
    var color = [],
        ...
        style = ".redacted>span:after{position:absolute;top:25%;bottom:25%;left:0;right:0;content:'';}",
        i;
